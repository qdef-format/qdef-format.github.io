(typeof globalThis !== 'undefined' ? globalThis : window).VALIDATOR_EXAMPLES = [
  {
    ...
    descriptor: 'A Bundle of two Records — an application-defined Wi-Fi credential (type 100) and a standard Open/Hint URI (type 10) — showing how custom and standard types coexist.',
    expectValid: true,
